...
export const PROVIDER_CAPABILITIES: ProviderCapability[] = [
  ...
  // ─── Financial / Cash Flow Integrations ────────────────────────────────
  {
    provider: 'paypal',
    name: 'PayPal',
    description: 'Payment processing data including transactions, invoices, balances, and settlement schedules',
    category: 'payments',
    icon: 'Wallet',
    color: 'blue',
    features: [
  ...
  },
  {
    provider: 'square',
    name: 'Square',
    description: 'Point-of-sale and payment data including transactions, inventory, customers, and deposits',
    category: 'payments',
    icon: 'Store',
    color: 'zinc',
    features: [
    ...
    requiredScopes: ['PAYMENTS_READ', 'ORDERS_READ', 'CUSTOMERS_READ'],
    docsUrl: 'https://developer.squareup.com/docs',
  },
  {
    provider: 'xero',
    name: 'Xero',
    description: 'Cloud accounting with invoices, bills, bank reconciliation, and real-time financial reporting',
    category: 'finance',
    icon: 'Receipt',
    color: 'cyan',
    features: [
    ...
    docsUrl: 'https://developer.xero.com/documentation/api/accounting',
  },
  {
    provider: 'freshbooks',
    name: 'FreshBooks',
    description: 'Invoicing and accounting data including clients, invoices, expenses, time tracking, and reports',
    category: 'finance',
    icon: 'FileText',
    color: 'green',
    features: [
    ...
    requiredScopes: ['user:invoices:read', 'user:expenses:read', 'user:clients:read'],
    docsUrl: 'https://www.freshbooks.com/api',
  },
  {
    provider: 'plaid',
    name: 'Plaid (Bank Accounts)',
    description: 'Connect any bank account for real-time balances, transaction history, and cash flow tracking across 12,000+ institutions',
    category: 'finance',
    icon: 'Landmark',
    color: 'zinc',
    features: [
    ...
    requiredScopes: ['transactions', 'auth', 'balance'],
    docsUrl: 'https://plaid.com/docs/',
  },
  {
    provider: 'mercury',
    name: 'Mercury',
    description: 'Startup banking data including account balances, transactions, treasury, and burn rate tracking',
    category: 'finance',
    icon: 'Building2',
    color: 'violet',
    features: [
  ...
  },
  {
    provider: 'wave',
    name: 'Wave',
    description: 'Free accounting with invoicing, expense tracking, receipts, and financial reporting for small businesses',
    category: 'finance',
  ...
  },
  {
    provider: 'brex',
    name: 'Brex',
    description: 'Corporate card and spend management data including transactions, budgets, and expense policies',
    category: 'finance',
    icon: 'CreditCard',
    color: 'orange',
    features: [
  ...
  },
  {
    provider: 'gusto',
    name: 'Gusto',
    description: 'Payroll and HR data including employee costs, benefits, tax obligations, and payroll history',
    category: 'hr',
    icon: 'DollarSign',
    color: 'rose',
    features: [
    ...
    requiredScopes: ['payrolls:read', 'employees:read', 'companies:read'],
