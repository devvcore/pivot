...
export const CHAPTER_GROUPS: Record<string, SectionGroup[]> = {
  ...
  // ── Operations & Team ─────────────────────────────────────────────────────
  operations: [
    { id: "efficiency", label: "Operational Efficiency", description: "Process optimization and automation", sections: ["operationalEfficiency", "processEfficiency", "processAutomation", "workflowAutomation", "processDigitization", "automationAudit", "toolConsolidation", "documentManagement", "meetingEfficiency", "meetingCulture", "decisionEfficiency"] },
